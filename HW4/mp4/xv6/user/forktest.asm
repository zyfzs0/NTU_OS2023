...
forktest(void)
{
  ...
  3e:	3fe50513          	addi	a0,a0,1022 # 438 <symlink+0xc>
  ...
  68:	3e450513          	addi	a0,a0,996 # 448 <symlink+0x1c>
  ...
  b8:	3e450513          	addi	a0,a0,996 # 498 <symlink+0x6c>
  ...
  d4:	39850513          	addi	a0,a0,920 # 468 <symlink+0x3c>
  ...
  ee:	39650513          	addi	a0,a0,918 # 480 <symlink+0x54>
